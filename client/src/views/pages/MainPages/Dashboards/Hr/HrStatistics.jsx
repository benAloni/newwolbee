...
export default function HrStatistics() {
  ...
  const EmployeeList = () => {
    ...
    const employeesOver100 = employees.filter(
      (employee) => employee.hours > 100
    );
    ...
    return (
      ...
      >
        <h2
          style={{ color: "black", textAlign: "center", marginBottom: "50px" }}
            ...
            >
              <div className="row g-0">
                <div className="col-md-8">
                  <div
                    className="card-body "
                    style={{ ...customHeight(150), width: "450px" }}
                  >
          ...
          <div className="col">
            ...
            >
              <div className="card-body">
                ...
                <br />
                <br />
                <h3 style={{ alignItems: "center", marginLeft: "10px" }}>
                  Spent Budget{" "}
                </h3>
                {/* <br/><br/><br/><br/><br/><br/> */}
                <h2 style={{ alignItems: "center", marginLeft: "40px" }}>
                  800$
                </h2>
              </div>
            </div>
            ...
            <div
              style={{ width: "350px", marginRight: "100px", padding: "2px" }}
              className="col-sm-12 col-md-12 col-lg-12"
            >
                  ...
                  <div className="col-md-8">
                    <div className="card-body">
                      ...
                      <h1 style={{ fontSize: "30px" }} className="card-title">
                        <br />
                        {selectedTeam
                          ? selectedTeam["Frequent Sick Leave"]
                          : "0"}
                      </h1>
                    </div>
                  </div>
