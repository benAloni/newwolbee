...
const gallery1Images = [
  ...
  { id: 9, src: food, price: 30, link: "https://wolt.com/he/isr" },
  {
    ...
    src: vegangift,
    price: 130,
    link: "https://vegansupplies.co.il/home?utm_medium=adwords&utm_campaign=&utm_source=&gad_source=1&gclid=Cj0KCQjwvb-zBhCmARIsAAfUI2vajooQ1XbSCi_09rn9LdTg0KnenNNs647-W9MabBfwtOspFZ9UNQsaAhOiEALw_wcB",
  },
  {
    id: 11,
    src: asiagift,
    price: 150,
    link: "https://www.eastwest-stores.co.il/he/",
  },
...
const gallery2Images = [
  {
    ...
    src: vip,
    price: 200,
    link: "https://buyme.co.il/supplier/22546?gad_source=1&gclid=CjwKCAjw9cCyBhBzEiwAJTUWNacKmPMLAUTjrqak9HNikzMNZafdtyKyz8Xd_Awqqb0OtjBwOVgOZxoCo40QAvD_BwE",
  },
  {
    id: 3,
    src: omer,
    price: 300,
    link: "https://2207.kupat.co.il/show/omer-adam",
  },
  {
    id: 4,
    src: amir,
    price: 400,
    link: "https://www.amirdadon.com/he/home#!live",
  },
  {
    id: 5,
    src: shlomi,
    price: 500,
    link: "https://comy.co.il/event/shlomi-koriat/",
  },
  {
    id: 5,
    src: eyalgolan,
...
const gallery3Images = [
  {
    ...
    src: spa,
    price: 220,
    link: "https://www.roxonsparamatgan.co.il/%D7%97%D7%91%D7%99%D7%9C%D7%95%D7%AA-%D7%94%D7%A6%D7%A2%D7%95%D7%AA/?utm_source=google_ads&utm_medium=cpc&utm_campaign=%D7%A7%D7%9E%D7%A4%D7%99%D7%99%D7%9F%20%D7%A1%D7%A4%D7%90%20%D7%9E%D7%9E%D7%95%D7%A7%D7%93%2010%20%D7%A7%D7%9E&utm_content=%D7%A1%D7%A4%D7%90&AgId=%D7%A1%D7%A4%D7%90&content_site=&utm_ad=661319313766&utm_term=%D7%A1%D7%A4%D7%90&matchtype=b&device=c&GeoLoc=1007981&placement=&network=g&campaign_id=20256951578&adset_id=147306874942&ad_id=661319313766&gad_source=1&gclid=Cj0KCQjwvb-zBhCmARIsAAfUI2uIFUk7RsNThHWk19ZMh3B56YSC1E1YzFyfAyvrC852oebjewJz-FIaApCBEALw_wcB",
  },
  {
    id: 14,
    src: yoga,
    price: 250,
    link: "https://www.physi-yoga.org/?gclid=Cj0KCQjwvb-zBhCmARIsAAfUI2talXTMNcQoPdLhgignz5PKWv0mLv80NkOFkPulETsRKw0rqalN3AYaAuqJEALw_wcB",
  },
  {
    id: 14,
    src: meditazia,
    price: 230,
    link: "https://newmanvipassana.co.il/personalcourse/?gad_source=1&gclid=Cj0KCQjwvb-zBhCmARIsAAfUI2uJ_aUq08z7Zaa4A-Gi7SJsNE9zbXqrGXlgl0_a60pJgY-t6xCux94aAvL3EALw_wcB",
  },
  {
    id: 15,
    src: hotel,
    price: 400,
    link: "https://www.fattalgifts.co.il/?utm_source=google-ads&utm_campaign&utm_agid=150645426479&utm_term=%D7%9E%D7%AA%D7%A0%D7%95%D7%AA&creative=665980449544&device=c&placement&gad_source=1&gclid=Cj0KCQjwvb-zBhCmARIsAAfUI2sRPnnT6JcWR4hEBDrJAmkR_e5kTJgulj5EHLVYGW_-bZMV5zsX5hkaAtVREALw_wcB",
  },
...
const HrServiceCompany = () => {
  const [maxPrice, setMaxPrice] = useState(500);

  const filterImagesByPrice = (images) =>
    images.filter((image) => image.price <= maxPrice);
  ...
  const galleries = [
    { id: 1, title: "Food", images: filterImagesByPrice(gallery1Images) },
    {
      id: 2,
      title: "Performances",
      images: filterImagesByPrice(gallery2Images),
    },
    {
      id: 3,
      title: "Relxing gifts",
      images: filterImagesByPrice(gallery3Images),
    },
    {
      id: 4,
      title: "Fashion and grooming",
      images: filterImagesByPrice(gallery4Images),
    },
  ];
...
export default HrServiceCompany;
