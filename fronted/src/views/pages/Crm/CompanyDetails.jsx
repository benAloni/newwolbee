        ...
        <div className="contact-wrap">
          <div className="contact-profile">
            ...
            <div className="name-user">
              <h4>NovaWave LLC</h4>
              <p><i className="las la-map-marker" /> 22, Ave Street, Newyork, USA</p>
      ...
      <div className="col-xl-3">
        <div className="card contact-sidebar">
          ...
          <ul className="other-info">
            ...
            <li><span className="other-title">Last Modified</span><span>27 Sep 2023, 11:45 pm</span></li>
          ...
          <ul className="company-info com-info">
            ...
            <li>
              ...
              <div>
                ...
                <p><i className="las la-star" />4.2</p>
              </div>
            </li>
          </ul>
