...
import SendMail from "../../../components/Modals/Crm/SendMail";
import AddDealsContactDetail from "../../../components/Modals/Crm/AddDealsContactDetail";
import AddCompany from "../../../components/Modals/Crm/AddCompany";
import EditContact from "../../../components/Modals/Crm/EditContact";
import DeleteContactDetails from "../../../components/Modals/Crm/DeleteContactDetails";
                      ...
                      <div className="calls-box">
                        ...
                        <div className="notes-editor">
                          <div
                            className="note-edit-wrap"
                            style={{
                              display: showFirstField1 ? "block" : "none",
                            }}
                          >
                            <div className="summernote">
                              Write a new comment, send your team notification
                      ...
                      <div className="calls-box">
                        ...
                        <div className="notes-editor">
                          <div
                            className="note-edit-wrap"
                            style={{
                              display: showFirstField2 ? "block" : "none",
                            }}
                          >
                            <div className="summernote">
                              Write a new comment, send your team notification
