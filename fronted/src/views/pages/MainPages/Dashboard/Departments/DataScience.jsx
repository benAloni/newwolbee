...
export default function DataScience() {
    ...
    return (
      <div className="team-satisfaction" style={{height:'150px'}}>
        ...
        <div className="progress-bar">
          <span className=""></span>
          <h5 className="card-title text-light text-center percentage">55%</h5>
  ...
  Activities
                    ...
                    <h1 style={{ color: 'black', textAlign: 'center' ,marginLeft: '50px'}}>1</h1>
                  </div>
                </div>
                ...
                <div className="row g-0">
                  <div className="col-md-8">
                    <div className="card-body">
                      ...
                      <h5 className="card-title">1/8</h5>
                    </div>
                  </div>
                ...
                <div className="row g-0">
                  <div className="col-md-8">
                    <div className="card-body d-flex">
                      ...
                      <div>
                        <h1 className="card-title">5/8</h1>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4">
              ...
              <div className="row g-0">
                <div className="col-md-8" >
                  <div className="card-body" style={{width:'220px'}}>
                    ...
                    <h1   style={{ color: 'black', textAlign: 'center', fontSize:'40px' }}>2/8</h1>
                  </div>
                </div>
                <div className="col-md-4">
                  <img
