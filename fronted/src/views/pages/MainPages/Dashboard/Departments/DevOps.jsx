...
export default function DevOps() {
  ...
  Activities
                    ...
                    <h1 style={{ color: 'black', textAlign: 'center' ,marginLeft: '50px'}}>2</h1>
                  </div>
                </div>
        ...
        <div className="row g-0">
                <div className="col-md-8">
                  <div className="card-body " style={{ ...customHeight(260) }}>
                    ...
                    <h1 style={{ color: 'black', textAlign: 'center' }}>7/8</h1>
                  </div>
                </div>
                <div className="col-md-4" style={{marginTop:'50px'}}>
                  <img
                ...
                <div className="row g-0">
                  <div className="col-md-8">
                    <div className="card-body d-flex">
                      ...
                      <div>
                        <h1 className="card-title">0/8</h1>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4">
              ...
              <div className="row g-0">
                <div className="col-md-8" >
                  <div className="card-body" style={{width:'220px'}}>
                    ...
                    <h1   style={{ color: 'black', textAlign: 'center', fontSize:'40px' }}>3/8</h1>
                  </div>
                </div>
                <div className="col-md-4">
                  <img
