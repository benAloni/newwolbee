...
const Statistics = () => {
  ...
  <div className="card flex-fill">
    <div className="card-body" style={{ padding: '4rem' }}>
      <h4 className="card-title" style={{ fontSize: '2rem' }}>Budget Breakdown</h4>
    ...
    <div className="card-body">
      ...
      <div className="stats-list">
        <div className="stats-info d-flex align-items-center">
          <img src={nicole} alt="Nicole" className="me-2" style={{ width: '50px', height: '50px', border: 'none', borderRadius: '100%' }} />
          <div className="w-100">
            <p>
              Nicole{" "}
              <strong>
        ...
        <div className="stats-info d-flex align-items-center">
          <img src={brad} alt="Brad" className="me-2" style={{ width: '50px', height: '50px', border: 'none', borderRadius: '100%' }} />
          <div className="w-100">
            <p>
              Brad{" "}
              <strong>
        ...
        <div className="stats-info d-flex align-items-center">
          <img src={lisa} alt="Lisa" className="me-2" style={{ width: '50px', height: '50px', border: 'none', borderRadius: '100%' }} />
          <div className="w-100">
            <p>
              Lisa{" "}
              <strong>
        ...
        <div className="stats-info d-flex align-items-center">
          <img src={tom} alt="Tom" className="me-2" style={{ width: '50px', height: '50px', border: 'none', borderRadius: '100%' }} />
          <div className="w-100">
            <p>
              Tom{" "}
              <strong>
        ...
        <div className="stats-info d-flex align-items-center">
          <img src={david} alt="David" className="me-2" style={{ width: '50px', height: '50px', border: 'none', borderRadius: '100%' }} />
          <div className="w-100">
            <p>
              David{" "}
              <strong>
