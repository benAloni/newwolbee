...
const handleSeeAllClick = () => {
  ...
  return (
    <div className="newHrS" style={{
      marginLeft: "195px", height: "100%", background: "linear-gradient(to bottom right, #ffcc80, rgb(28 105 123 / 3%))",
      position: "fixed", width: "100%", marginBottom:"80px"
    }}>
    <div className="newHeader" style={{ marginTop:"20px", fontWeight: "1000", height:"100px" }}>
  ...
  alt="Profile"
  onError={() => console.error("Error loading image:", userProfileImage)}
/>
      ...
      <div className="newHrS" style={{ display: "flex" }}>
        <div>
          <h1 className="nH1" style={{ textAlign: "left", top: "50px", marginLeft: "65px", fontWeight: "850", fontSize:"40px" }}>
            {greeting}
          </h1>
        </div>
        <div className="newSelect" style={{
            padding: "0px",
            position: "relative",
            top: "5px",
            borderRadius: "10px",
      ...
      <div className="newContent" style={{ marginLeft: "50px" }}>
        <div className="newRow1" style={{ display: "flex", flexWrap: "wrap", }}>
...
>
  Members
            ...
            <br />
            <div className="scrollableContent" style={{ maxHeight: "220px", overflowY: "auto", padding: "10px" }}>
              <div
                style={{
                  display: "grid",
                ...
                {employees &&
                  filteredEmployees?.map((employee) => (
                    ...
                    >
                      ...
                      >
                        <Link to={`/profile/${employee._id}`} style={{ textDecoration: "none", color: "inherit" }}>
                          <br />
                          <br />
                          {employee.fullName}
                        </Link>
...
>
  <h3 className="titelH3" style={{ marginTop: "-15px", fontWeight: "700" }}>
    Team Satisfaction
  </h3>
  <div
    style={{
...
>
  ...
  <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column", marginTop: "20px" }}>
    <h5 style={{ textAlign: "center", opacity: 0.8 }}>At this stage of the year, it is</h5>
    <h5 style={{ textAlign: "center", opacity: 0.8 }}>recommended to use at least 76%</h5>
  </div>
</div>
...
>
  Employees Over 100% Hours
            ...
            <EmployeeGrph employees={employees}></EmployeeGrph>
          </div>
    ...
    />
          ...
          <div style={styles.card}>
            ...
            <ul style={styles.birthdayList}>
              {getVisibleBirthdays().map((employee, index) => (
